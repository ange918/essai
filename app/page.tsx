...
const faqs = [
  ...
  { question: "Comment fonctionne la prime de bienvenue de 3 200 € ?", answer: "Dès l'activation de votre compte par notre équipe, la prime de 3 200 € est créditée directement sur votre solde." },
  { question: "Quels documents sont nécessaires pour la vérification d'identité ?", answer: "Nous acceptons les cartes nationales d'identité, passeports et titres de séjour en cours de validité." },
  { question: "Mon argent est-il en sécurité chez NELLOA BANK ?", answer: "Oui, absolument. NELLOA BANK utilise un chiffrement bancaire de niveau militaire (SSL 256 bits) et une authentification à deux facteurs." },
  { question: "Puis-je changer de type de compte après l'ouverture ?", answer: "Oui. Vous pouvez faire une demande de changement de formule depuis votre espace client." },
  { question: "Comment contacter le service client ?", answer: "Notre équipe est disponible 7j/7 par email et par chat en direct depuis votre espace client." },
]
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background">
      ...
      <section className="relative flex items-center justify-center min-h-[680px] overflow-hidden">
        ...
        <div className="container relative z-10 px-4 py-24 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 max-w-4xl mx-auto tracking-tight">La banque qui vous fait confiance</h1>
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">Ouvrez votre compte en 3 minutes et accédez à votre espace sécurisé.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register"><Button size="lg" className="bg-white text-[#1E3A8A] hover:bg-white/90 font-semibold text-base h-14 px-8 rounded-full shadow-lg">Commencer maintenant</Button></Link>
              <a href="#offres"><Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 h-14 px-8 rounded-full">Voir nos offres</Button></a>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="offres" className="py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16 max-w-6xl mx-auto">
            <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2"><span className="h-8 w-1 rounded-full bg-primary inline-block" />Compte Bancaire</h3>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { href: "/offres/compte-personnel", Icon: CreditCardIcon, titre: "Compte Personnel", desc: "L'essentiel pour vos dépenses quotidiennes.", avantages: ["IBAN personnel", "Carte virtuelle", "Suivi des dépenses"], popular: false },
                { href: "/offres/compte-business", Icon: BuildingOffice2Icon, titre: "Compte Business", desc: "Pour les entrepreneurs et professionnels.", avantages: ["Virements illimités", "Domiciliation bancaire", "Chéquier"], popular: true },
                { href: "/offres/carte-bancaire", Icon: SparklesIcon, titre: "Carte Bancaire", desc: "Visa classique ou Gold internationale.", avantages: ["Paiement sans contact", "Cashback 2 %", "Assurance voyage"], popular: false },
              ].map((offre) => (
                <div key={offre.href} className={`bg-card rounded-2xl p-7 border flex flex-col transition-all duration-200 hover:shadow-md relative ${offre.popular ? "border-2 border-primary shadow-md md:-translate-y-2" : "border-border"}`}>
                  ...
                  <div className="flex items-center justify-center gap-2 bg-green-50 text-green-700 p-2.5 rounded-lg mb-5 text-sm font-medium"><GiftIcon className="h-4 w-4 shrink-0" />3 200 € offerts à l&apos;ouverture</div>
                  <Link href={offre.href}><Button className="w-full" variant={offre.popular ? "default" : "outline"}>Découvrir l&apos;offre</Button></Link>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mb-16 max-w-6xl mx-auto">
            <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2"><span className="h-8 w-1 rounded-full bg-secondary inline-block" />Crédit Bancaire</h3>
            <div className="grid md:grid-cols-3 gap-6">
              {[
          ...
          <div className="max-w-6xl mx-auto">
            <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2"><span className="h-8 w-1 rounded-full bg-purple-500 inline-block" />Assurance Partenaire</h3>
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
              {[
                { href: "/assurances/assurance-vie", Icon: ShieldCheckIcon, titre: "Assurance Vie", desc: "Préparez l'avenir et protégez vos proches avec un placement à long terme.", tag: "Capital garanti" },
                { href: "/assurances/assurance-habitat", Icon: HomeModernIcon, titre: "Assurance Habitat", desc: "Couvrez votre logement contre tous les risques : incendie, dégât des eaux, vol.", tag: "Attestation immédiate" },
              ].map((a) => (
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Comment ça marche ?</h2></div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              { Icon: BoltIcon, title: "Ouverture en 3 min", desc: "Fini les rendez-vous en agence. Ouvrez votre compte entièrement en ligne." },
          ...
          <div className="mt-16 bg-gradient-to-r from-[#1E3A8A] to-[#3B82F6] rounded-2xl p-10 text-center max-w-4xl mx-auto">
            ...
            <Link href="/register"><Button size="lg" className="bg-white text-[#1E3A8A] hover:bg-white/90 font-semibold h-12 px-8 rounded-full">Ouvrir mon compte gratuitement</Button></Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((t, i) => (
              <motion.div key={t.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.1 }} className="bg-card rounded-2xl p-8 border border-border shadow-sm flex flex-col gap-5 hover:shadow-md transition-all duration-200">
                ...
                <div className="flex items-center gap-4 pt-2 border-t border-border">
                  ...
                  <div><p className="font-semibold text-foreground text-sm">{t.name}</p><p className="text-muted-foreground text-xs">{t.role}</p></div>
