  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        data-testid={`nav-dropdown-${label}`}
      >
        {label}
            ...
            <SheetContent side="right" className="flex flex-col gap-0 pt-10 overflow-y-auto">
              ...
              <div className="border-t border-border pt-4 flex flex-col gap-3 mt-2">
                <Link href="/login" onClick={() => setIsMenuOpen(false)}>
                  <Button variant="outline" className="w-full border-primary text-primary">Connexion</Button>
                </Link>
                <Link href="/register" onClick={() => setIsMenuOpen(false)}>
                  <Button className="w-full bg-primary text-white">Ouvrir un compte</Button>
                </Link>
              </div>
            </SheetContent>
          </Sheet>
